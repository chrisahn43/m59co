PRO psfdrizz
  ...
  fits_read,'f475w_flt.fits',zero,header,exten_no=0
  fits_read,'f475w_flt.fits',img,header_sci,exten_no=1
  fits_read,'f475w_flt.fits',err,header_err,exten_no=2
  fits_read,'f475w_flt.fits',dq,header_dq,exten_no=3
  outhead=header
  imgsize=size(img,/dim)
  fits_read,'f475w_psf.fits',psf
  temp=img[2494:3494,0:500]
  find_galaxy,temp,majorAxis,eps,ang,xc,yc
  find_galaxy,psf,majoraxis1,eps1,ang1,xcpsf,ycpsf
  img[*,*]=0.0

  img[(xc+2494)-(xcpsf):(xc+2494)+xcpsf,0:(yc+0)+ycpsf]=psf[*,45:242]
  outim='psfonimg.fits'
