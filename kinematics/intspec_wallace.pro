...
initvel=708.;from Chilingarian 2008
READCOL,'intspec/spectra_fwhm_goodmay.dat',rin,rout,avrad,fwhm,filename,FORMAT='F,F,F,F,A'
;fwhm[*]=4.0
...
;outplotfile='vor_out/intspec_wallace_goodmay.ps'
...
outfile='vor_out/intspec_wallace_goodmay.dat'
...
;   ppxf_phoenix,lambda,flux,var,fwhm[i],outrv=vel,outdisp=disp,outsol=sol,binnum=i,initvel=initvel,nodispchi=nodispchi,outerror=err,/doerror,residsn=residsn
;   printf,1,infiles[i],rin[i],rout[i],avrad[i],residsn,sol[6],sol[0],err[0],err[1],sol[1],err[2],err[3],sol[2],err[4],err[5],sol[3],err[6],err[7],sol[7],err[8],err[9],sol[9],err[10],err[11],nodispchi,FORMAT='(A30,24F9.3)'
   dispersion[i]=sol[1]
...
SET_PLOT,'x'
!P.MULTI=[0,1,1]
djs_plot,avrad*0.05,dispersion,psym=4,ytitle='Dispersion (km/s)',xtitle='Radius (arcseconds)',xran=[0.,0.9],yran=[25,55],/xsty
