...
outfile='m59co_combine_goodmay.fits'

READCOL,'Catlist_goodmay',fitsfiles,FORMAT='A'
READCOL,'integer_offsets_goodmay.dat',xoff,yoff,FORMAT='I,I'
...
FOR i=0,nim-1 DO BEGIN
    im=(READFITS(fitsfiles[i],ext=1))[0:imsize[0]-1,0:imsize[1]-1,*]
    var=(READFITS(fitsfiles[i],ext=2))[0:imsize[0]-1,0:imsize[1]-1,*]
    dq=(READFITS(fitsfiles[i],ext=3))[0:imsize[0]-1,0:imsize[1]-1,*]
