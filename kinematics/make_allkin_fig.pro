...
;    xyouts,-0.7,0.88,'PSF FWHM!c(0.08" core)',charsize=2.0
...
;make the 255th color gray
    ...
    contour,cont,xcoord,ycoord,/overplot,levels=klevels,thick=4
    COLORBAR,range=[min(h3levels),max(h3levels)+dellev],format='(F5.2)',/vertical,right=1,divisions=5,charsize=2.0,title='h!d3!n',POSITION=[!X.WINDOW[1],!Y.WINDOW[0],!X.WINDOW[1]+0.03,!Y.WINDOW[1]]
...
;    axis,/xaxis,xrange=[xmin,xmax],/xsty,xtitle='RA Offset [pc]',charsize=2.0
    ...
    contour,cont,xcoord,ycoord,/overplot,levels=klevels,thick=4
    COLORBAR,range=[min(h4levels),max(h4levels)+dellev],format='(F5.2)',/vertical,right=1,divisions=5,charsize=2.0,title='h!d4!n',POSITION=[!X.WINDOW[1],!Y.WINDOW[0],!X.WINDOW[1]+0.03,!Y.WINDOW[1]]
