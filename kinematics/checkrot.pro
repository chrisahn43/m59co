PRO CHECKROT
  ...
  infile='./vor_out/intspec_wallace_goodmay.dat'
  ...
  forprint,rav,vel,velerr,disp,disperr,format='F,F,F,F,F',textout='checkrot_left.dat'
  xbin=rav*.05
  set_plot,'ps'
  device,filename='checkrot_left.ps',/color
  djs_plot,xbin,disp,psym=4,ytitle='Dispersion (km/s)',xtitle='Radius (arcseconds)',xran=[0.,0.52],yran=[25,45],/xsty,charsize=1.5,charthick=4,xthick=3,ythick=3,symsize=2
  ...
  djs_plot,xbin,rdisp,psym=2,ytitle='Dispersion (km/s)',xtitle='Radius (arcseconds)',xran=[0.,0.52],yran=[25,45],/xsty,charsize=1.5,charthick=4,xthick=3,ythick=3,symsize=2
  ...
  djs_plot,xbin,rvel,psym=2,ytitle='Velocity (km/s)',xtitle='Radius (arcseconds)',xran=[0.,0.52],yran=[min(vel)-5,max(vel)+5],/xsty,charsize=1.5,charthick=4,xthick=3,ythick=3,symsize=2,/ysty
  ...
  djs_plot,xbin,rvel-lvel,psym=2,ytitle='Velocity (km/s)',xtitle='Radius (arcseconds)',xran=[0.,0.52],yran=[min(rvel-lvel)-5,max(rvel-lvel)+5],/xsty,charsize=1.5,charthick=4,xthick=3,ythick=3,symsize=2,/ysty
