...
infile='intspec_wallace_goodmay.dat'
...
myplot,file='disp_profile_goodmay.ps',ysize=6,/inches
!P.MULTI=[0,1,2]
loadct,13
plot,rav*0.05,disp,psym=4,xtitle='Radius ["]',ytitle='Dispersion [km/s]',chars=2,yrange=[16,46],ymargin=[-3,3.5],xchars=0.0001,thick=3,/ysty,xrange=[0,0.6],xmargin=[7,1.5]
...
plot,rav*0.05,sn,xtitle='Radius ["]',ytitle='S/N',chars=2,ymargin=[3.5,3],psym=4,yrange=[10,49],/ysty,thick=5,xrange=[0,0.6],xmargin=[7,1.5]
